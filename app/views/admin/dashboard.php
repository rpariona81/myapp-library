                ...
                <div class="card-p mb-5">
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                            ...
                            <!--end::Svg Icon-->
                            <a href="#" class="text-primary fw-bold fs-6">Convocatorias vigentes</a>
                        </div>
                        <!--end::Col-->
                    </div>
                    <!--end::Row-->
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col bg-light-success px-6 py-8 rounded-2">
                            ...
                            <span class="svg-icon svg-icon-3x svg-icon-success d-block my-2">
                                ...
                                </svg>&nbsp;<?= $cantPostulations ?>
                            </span>
                            <!--end::Svg Icon-->
                            <a href="#" class="text-success fw-bold fs-6 mt-2">Postulaciones registradas</a>
                        </div>
                        <!--end::Col-->
                    </div>
                </div>
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item px-4 pb-4">
                        <p class="mb-2 font-weight-bold"><strong class="text-primary"><?= $item->career_title ?></strong>
                            <strong class="float-end text-secondary"><?= ($item->cant_Users) ? $item->cant_Users : 0 ?></strong>
                        </p>
