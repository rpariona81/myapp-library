            ...
            <div class="card-header border-bottom pb-0">
                <div class="d-sm-flex align-items-center">
                    ...
                    <div class="ms-auto d-flex">
                        <div class="mb-1">
                            <a class="btn waves-effect waves-light btn-danger pull-right hidden-sm-down" data-toggle="tooltip" data-placement="bottom" title="Crear nuevo registro" href="<?=base_url('/admin/newestudiante')?>">Nuevo usuario&nbsp;&nbsp;<i class="fa fa-plus"></i></a>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            ?>
                                            &nbsp;&nbsp;
                                            <a class="btn btn-outline-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Editar" href="<?=base_url('/admin/estudiante/'.$item->id) ?>"><i class="fa fa-edit"></i></a>
                                        </div>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
