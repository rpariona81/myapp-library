            ...
            <div class="card-header border-bottom pb-0 bg-secondary">
                ...
                <div class="row pt-3">
                    <div class="col-md-4 col-lg-4 align-self-center">
                        <div class="mb-3">
                            <h5 class="card-title text-dark">Docentes</h5>
                        </div>
                    </div>
                                ...
                                <tr class="align-middle">
                                    ...
                                    <td>
                                        ...
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            ...
                                            ?>
                                            &nbsp;&nbsp;
                                            <a class="btn btn-outline-warning btn-sm" data-bs-toggle="tooltip" data-bs-placement="left" title="Editar" href="<?= base_url('/admin/docente/' . $item->id) ?>"><i class="fa fa-edit"></i></a>
                                        </div>
                                    </td>
