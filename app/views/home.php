...
<body id="kt_body" class="app-blank bg-white">
	...
	<div class="d-flex flex-column flex-root" id="kt_app_root">
		...
		<div class="d-flex flex-column flex-lg-row flex-column-fluid">
			...
			<!--begin::Aside-->
			<div class="d-flex flex-lg-row-fluid w-lg-50 bgi-size-cover bgi-position-center order-1 order-lg-2 opacity-75" style="background-image: url(/assets/media/books/library-488690_1280.jpg)">
				<!--begin::Content-->
