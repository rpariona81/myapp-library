...
<body>
  ...
  <header id="header" class="header header-hide" style="height: 100px;">
    <div class="container">
      ...
      <nav id="nav-menu-container" style="margin-top: 1.1rem; font-size: 2em;">
        <ul class="nav-menu">
          ...
          <?php
                        ...
                        ?>
          <li class="menu-has-children"><a href="">Rol - Usuario</a>
            <ul>
  ...
  <!--==========================
    Datatables Section
  ============================-->
	<section id="content_app" class="padd-section wow fadeInUp mt-5">
    ...
    <div class="container">
	  ...
	  <div class="card-body">
                                    <div class="table-responsive">
                                        ...
                                        <table id="expendable-data-table" class="table display nowrap table-bordered table-hover" >
                                            <thead>
                                                <tr class="bg-warning">
                                                    <th></th>
                                                    <th>First name</th>
